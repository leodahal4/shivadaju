      ...
      <template v-slot:default>
        <v-container fluid>
          <v-row
            align="center"
            justify="center"
            class="text-h3 white--text mt-10 text-center font-weight-light"
          >
          ...
          <v-row align="center" justify="center">
            <v-col cols="12" sm="12" md="6" xs="12" lg="4">
              <v-text-field
                label="Enter your street address"
                placeholder="Enter your street address"
                outlined
                dark
                class="white--text ma-0 pa-0 mt-3"
                rounded
              >
          ...
          <v-row
            align="center"
            justify="center"
            class="white--text font-weight-bold text-caption text-center"
            no-gutters
          >
            Sell your home to House Buyers of America and avoid the
            <br />hassle of real estate agents, repairs and months of
            uncertainty.
          </v-row>
        </v-container>
      </template>
